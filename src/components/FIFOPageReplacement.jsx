...
const FIFOPageReplacement = () => {
  ...
  const handleSimulate = () => {
    ...
    references.forEach((page, step) => {
      ...
      if (hit) {
        log.push({ step: step + 1, page, result: 'HIT', frames: [...queue] });
      } else {
        ...
        log.push({ step: step + 1, page, result: 'MISS', frames: [...queue] });
      }
    });
  ...
  return (
    <div className="paging-container">
      <h2 style={{ color: '#00f0ff' }}>FIFO Page Replacement Simulation</h2>
